...
def plot_overview_pipeline_new(data, group_by_param):
    ...
    plot.title(
        'Overview of images generated by Dall-E', fontdict={"fontsize": 40}, pad=20)
    combination_pipeline = [
        element.replace("_processor_text", "").replace("_evaluator_text", "").replace("_processor_image", "").replace(
            "_evaluator_image", "") for element in combination_pipeline]
...
# example plots
file_path = '../../../pipeline_results/dalle-30.csv'
...
group_pipeline_generator_filter = None
