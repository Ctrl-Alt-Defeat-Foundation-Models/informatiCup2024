...
from fool_ai_detector.service.final_image_processor import FinalImageProcessor


class TestFinalImageProcessor:
    ...
    def test_final_image_process(self):
        self.set_up()

        final_image_processor = FinalImageProcessor()
        final_image_processor.process(self.output_generator_file_path, self.output_processor_file_path)
