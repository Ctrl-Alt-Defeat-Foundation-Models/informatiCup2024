from service.fake_generator_picture import FakeGeneratorPicture
import unittest
import os


class TestFakeGeneratorPicture(unittest.TestCase):
    output_file_path = "../../test_output/fake_generator_pictures/"
